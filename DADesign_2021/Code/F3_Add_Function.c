...
void Request(CSTree T){
    ...
    if(sum>3){
        printf("根据国家2021年5月31日，中共中央政治局召开会议，进一步优化生育政策\n");
        printf("该成员已满足要求\n");
    }else{
        printf("根据国家2021年5月31日，中共中央政治局召开会议，进一步优化生育政策\n");
        printf("该成员还未满足要求，请继续努力\n");
    }
    getchar();
    getchar();
}
...
int main(){
    ...
    while (1) {
        ...
        switch (num) {
            ...
            case 9: Request(T); break;
            case 0: exit(OVERFLOW); break;
